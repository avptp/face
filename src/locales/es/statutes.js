...
Se constituye la asociación denominada **Associació Valenciana pel Transport Públic** que se acoge a lo que dispone la [Ley Orgánica 1/2002, de 22 de marzo, reguladora del derecho de asociación](https://www.boe.es/buscar/act.php?id=BOE-A-2002-5852) y a la [Ley 14/2008, de 18 de noviembre de 2008, de asociaciones de la Comunitat Valenciana](http://www.dogv.gva.es/datos/2008/11/25/pdf/2008_13709.pdf), y al amparo de lo dispuesto en el [artículo 22 de la Constitución española](https://www.boe.es/buscar/act.php?id=BOE-A-1978-31229&tn=1&p=20110927#a22), y esta no tiene ánimo de lucro.
...
- Hacer del transporte público un derecho fundamental garantizado.
- La posibilidad de realizar cualquier desplazamiento en transporte público sin la necesidad de disponer de vehículo en propiedad, vertebrando así el territorio.
- La mejora del transporte público en todo el ámbito de actuación, incluyendo:
    - Equidad y sencillez para que esté al alcance de todas las personas.
    - Eficiencia y planificación racional respetuosa con el entorno.
    - Integración e intermodalidad entre diferentes medios de transporte.
- El fomento del uso de métodos de transporte público y sostenible en detrimento de aquellos que no lo son, para minimizar el impacto medioambiental y urbanístico de la necesidad de transporte.
- La defensa de los intereses generales y de los usuarios del transporte público y sostenible.
...
- Los menores no emancipados, de más de catorce años, deben contar con el consentimiento documentalmente acreditado de las personas que deban suplir su capacidad.
...
### Artículo 6: derechos de las personas asociadas

Los derechos que corresponden a las personas asociadas son los siguientes:

- A participar en las actividades de la Asociación y en los órganos de gobierno y representación; a ejercer el derecho de voto, así como asistir con voz a la Asamblea General, de acuerdo con los Estatutos. Para poder ser miembro de los órganos de representación hay que ser mayor de edad, estar en pleno uso de los derechos civiles, y no estar incurso en los motivos de incompatibilidad establecidos en la legislación vigente.
...
- A ser escuchadas con carácter previo a la adopción de medidas disciplinarias contra estas, y ser informadas de los hechos que dan lugar a tales medidas, debiendo ser motivado el acuerdo que, en su caso, imponga la sanción.
- A impugnar los acuerdos de los órganos de la Asociación que estime contrarios a la Ley o a los Estatutos.
- A conocer los Estatutos y los reglamentos y normas de funcionamiento aprobados por los órganos de la Asociación. Asimismo, tendrán derecho a que se les facilite copia digital de los Estatutos vigentes y del Reglamento de Régimen Interno de la Asociación, si lo hay.
- A consultar los documentos de la Asociación.

### Artículo 7: deberes de las personas asociadas
...
- La propia voluntad de la persona interesada, comunicada formalmente a los órganos de representación. La cual podrá percibir la participación patrimonial inicial y otras aportaciones económicas realizadas sin incluir las cuotas de pertenencia a la Asociación y siempre que la reducción patrimonial no implique perjuicios a terceros.
- Defunción.
...
- Cuando realice, de forma deliberada y reiterada, cualquier tipo de ataque personal que esté fuera del ámbito de la argumentación y el debate racionales a cualquier persona, especialmente aquellos ataques relacionados con rasgos físicos, procedencia, sexo biológico, identidad sexual, orientación sexual, lengua o religión.
...
- Adoptar los acuerdos referentes a:
    ...
    - Acordar la unión de asociaciones, la integración en federaciones o confederaciones, la separación de éstas, así como la creación y participación en coordinadoras u otras organizaciones específicas.
...
- Ostentar y ejercitar la representación de la Asociación, llevar a cabo la dirección y la administración de la manera más amplia que reconozca la Ley y cumplir las decisiones tomadas por la Asamblea General, siempre de acuerdo con las normas, las instrucciones y las directrices generales que esta Asamblea establezca.
- Tomar los acuerdos necesarios para la comparecencia, ante los organismos públicos, para el ejercicio de cualquier clase de acciones legales y para interponer los recursos pertinentes.
...
- Comunicar al Registro de Asociaciones la modificación de los Estatutos acordada por la Asamblea General, en el plazo máximo de un mes.
...
- Llevar la contabilidad de acuerdo con normas específicas que permiten obtener la imagen fiel del patrimonio, del resultado y de la situación financiera de la entidad.
...
### Artículo 17: reuniones del órgano de representación
...
### Artículo 19: el/la vicepresidente/a
...
- De las aportaciones extraordinarias que, de forma voluntaria, efectúen sus socios.
...
- Si así lo acuerda la Asamblea General, convocada expresamente para este fin y con el voto favorable de más de tres quintas partes de las personas presentes o representadas.
...
- Aplicar los bienes sobrantes de la Asociación a los fines previstos por los Estatutos, salvo las aportaciones condicionales.
- Solicitar la cancelación de los asientos contables en el registro correspondiente.
...
Las cuestiones litigiosas que puedan surgir con motivo de las actuaciones desarrolladas o de las decisiones adoptadas en el seno de la Asociación, serán resueltas mediante arbitraje, a través de un procedimiento ajustado de acuerdo con lo dispuesto en la [Ley 60/2003, de 23 de diciembre, de arbitraje](https://www.boe.es/buscar/act.php?id=BOE-A-2003-23646), y con sujeción, en todo caso, a los principios esenciales de audiencia, contradicción e igualdad entre las partes o voluntariamente por mediación, de acuerdo con lo establecido en la [Ley 5/2012, de 6 de julio, de mediación en asuntos civiles y mercantiles](https://www.boe.es/buscar/act.php?id=BOE-A-2012-9112).`
}
