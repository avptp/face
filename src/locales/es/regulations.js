...
<p class="figure">
    <img src=${imagotype} width="300px" alt="Imagotipo">
    <span>
...
<p class="figure">
    <img src=${smallImagotype} width="200px"alt="Imagotipo reducido">
    <span>
...
<p class="figure">
    <img src=${isotype} height="100px" alt="Isotipo">
    <span>
        <strong>Figura 3:</strong> isotipo.
    </span>
</p>

La tipografía principal de la Asociación es Proxima Nova, mientras que [Greyscale Basic](https://www.fontsquirrel.com/fonts/greyscale-basic) se utiliza para formar el logotipo. Por otra parte, los colores que forman los elementos gráficos son los siguientes:
...
### Artículo 6: datos de los socios
...
El registro de entrada oficial de la Asociación es la siguiente dirección de correo electrónico: **[contacte@avptp.org](mailto:contacte@avptp.org)**.

### Artículo 8: votaciones de acuerdos
...
En el caso de votaciones a distancia o secretas en las que sea necesario votar entre más de dos opciones, se empleará el sistema electoral de [segunda vuelta instantánea](https://es.wikipedia.org/wiki/Segunda_vuelta_instant%C3%A1nea).
...
### Artículo 11: proceso electoral de la Junta Directiva
...
### Artículo 14: aplicación web

La Asociación mantiene una aplicación web en el dominio **[avptp.org](https://avptp.org)**.
...
- Estatutos, Reglamento de Régimen Interno e Idearios de la Asociación.
...
### Artículo 16: comunicados de prensa
...
### Artículo 18: representantes de la Asociación
...
- No guardar la debida compostura durante el desarrollo de reuniones o actividades de la Asociación.

Además, se consideran infracciones disciplinarias **graves**:

- No facilitar o faltar a la veracidad en los datos que deban ser suministrados a la Asociación según las disposiciones estatutarias y/o reglamentarias, o en función de los acuerdos que se adopten por los órganos de gobierno.
- La reiteración de una falta leve, si bien no se tienen en cuenta las cometidas con dos años de antigüedad.

Además, se consideran infracciones disciplinarias **muy graves**:

- La protesta o actuaciones airadas y/u ofensivas que impidan la celebración de asambleas o reuniones de la Junta Directiva.
- La usurpación de atribuciones o competencias sin contar con la preceptiva autorización del órgano competente.
- La violación de secretos de la Asociación que perjudiquen gravemente sus intereses.
- Agredir, amenazar o insultar gravemente a cualquier asociado.
- La reiteración de una falta grave o muy grave, si bien no se tienen en cuenta las cometidas con tres años de antigüedad.

### Artículo 21: infracciones de los miembros de la Junta Directiva
...
- La no convocatoria de los órganos de la Asociación en los plazos y condiciones estatutarias y reglamentarias.
...
- No facilitar a los socios el acceso a la documentación de la entidad.
...
- **Leve**: hasta tres meses, pudiendo recibir únicamente un apercibimiento.
- **Grave**: entre un mes y un año.
- **Muy grave**: entre un año y cuatro años.
